...
#в нейроне изначельно задаем случайный вес для каждого, вычисляем сумму весов для каждого нейрона с помощью функции активации и задаем дельту
class Neuron:
    ...
    def randomize_weights(self):   # Шаг 2 случайные веса
    ...
    # веса дельт прибавляем к весам нейрона
